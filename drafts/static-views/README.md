...
These are the first approved-direction review plates for MPC Master Dummy v1.
...
No animation frames should be built until these four static plates are approved.

## Files

```txt
master-dummy-front-idle-01-alpha.png
